...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebarAdmin"><br>
    <div class="w3-container w3-row">
        ...
        <div class="w3-col s8 w3-bar">
            ...
            <a href="{{ url('https://mail.google.com/mail/u/0/#inbox') }}" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i></a>
            <a href="{{ url('profile') }}" class="w3-bar-item w3-button"><i class="fa fa-user"></i></a>
            <a href="{{ url('admin/settings') }}" class="w3-bar-item w3-button"><i class="fa fa-cog"></i></a>
        </div>
    </div>
    <hr>
    ...
    <div class="w3-bar-block">
        ...
        <a href="{{url('admin/news')}}" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bell fa-fw"></i>  Newsletter</a>
        @else
        <a href="{{url('admin/news')}}" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bell fa-fw"></i>  Newsletter</a>
        @endif
