                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="form-list">
                                            <li>
                                                ...
                                                <input type="text" title="Email Address" onfocus="this.value = '';" onblur="if (this.value == '')"
                                                       class="input-text required-entry" id="email" value="{{ old('email') }}" required autofocus name="email" {{ $errors->has('email') ? ' is-invalid' : '' }} >
                                                @if ($errors->has('email'))
                                            ...
                                            <li>
                                                ...
                                                <input type="password"  title="Password" id="pass" class="input-text required-entry validate-password" name="password" requiredplaceholder="Password" required {{ $errors->has('password') ? ' is-invalid' : '' }} name="password" required>
